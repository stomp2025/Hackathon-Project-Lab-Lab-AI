...
export default function HeartRateMonitoringScreen() {
  // Données simulées de fréquence cardiaque (en BPM)
  const hrData = {
    labels: ["", "", "", "", "", ""],
    datasets: [
      {
        data: [
          ...
          Math.floor(Math.random() * 10 + 74),
          Math.floor(Math.random() * 10 + 73),
          Math.floor(Math.random() * 10 + 71),
        ],
      },
    ],
  }
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.analysisContainer}>
        <View style={styles.analysisHeader}>
          <Ionicons name="analytics" size={24} color="#FF3A5E" />
          <Text style={styles.analysisTitle}>AI Analysis</Text>
        </View>
        <Text style={styles.analysisText}>
          No arrhythmia detected. Heart rate is within normal range.
        </Text>
      </View>
      ...
      <View style={styles.historyContainer}>
        ...
        <View style={styles.eventItem}>
          ...
          <View style={styles.eventContent}>
            <Text style={styles.eventTitle}>Peak during exercise</Text>
            <Text style={styles.eventDescription}>Heart rate reached 120 BPM during training.</Text>
          </View>
        </View>
        <View style={styles.eventItem}>
          <View style={styles.eventTimeContainer}>
          ...
          <View style={styles.eventContent}>
            ...
            <Text style={styles.eventDescription}>Heart rate stable (72 BPM).</Text>
          </View>
        </View>
      </View>
    </SafeAreaView>
...
const styles = StyleSheet.create({
  ...
  liveIndicator: { flexDirection: "row", alignItems: "center", backgroundColor: "rgba(255, 58, 94, 0.2)", paddingHorizontal: 12, paddingVertical: 6, borderRadius: 16 },
  liveDot: { width: 8, height: 8, borderRadius: 4, backgroundColor: "#FF3A5E", marginRight: 6 },
  liveText: { color: "#FF3A5E", fontSize: 14, fontWeight: "500" },
