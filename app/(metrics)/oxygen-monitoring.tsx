...
export default function OxygenMonitoringScreen() {
  // Données simulées de saturation en oxygène (en %)
  const spo2Data = {
    labels: ["", "", "", "", "", ""],
    datasets: [
      {
        data: [
          Math.floor(Math.random() * 2 + 97),
          Math.floor(Math.random() * 2 + 97),
          Math.floor(Math.random() * 2 + 97),
          Math.floor(Math.random() * 2 + 97),
          Math.floor(Math.random() * 2 + 97),
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.title}>Oxygen Saturation Monitoring</Text>
      ...
      <View style={styles.analysisContainer}>
        ...
        <Text style={styles.analysisText}>
          Oxygen saturation is within normal range. No hypoxemia detected.
        </Text>
      </View>
      ...
      <View style={styles.historyContainer}>
        ...
        <View style={styles.eventItem}>
          ...
          <View style={styles.eventContent}>
            <Text style={styles.eventTitle}>Slight drop</Text>
            <Text style={styles.eventDescription}>SpO₂ dropped to 95% after intense effort.</Text>
          </View>
        </View>
        <View style={styles.eventItem}>
          <View style={styles.eventTimeContainer}>
          ...
          <View style={styles.eventContent}>
            ...
            <Text style={styles.eventDescription}>SpO₂ stable (98%).</Text>
          </View>
        </View>
      </View>
    </SafeAreaView>
...
const styles = StyleSheet.create({
  ...
  liveIndicator: { flexDirection: "row", alignItems: "center", backgroundColor: "rgba(76, 175, 80, 0.2)", paddingHorizontal: 12, paddingVertical: 6, borderRadius: 16 },
  liveDot: { width: 8, height: 8, borderRadius: 4, backgroundColor: "#4CAF50", marginRight: 6 },
  liveText: { color: "#4CAF50", fontSize: 14, fontWeight: "500" },
