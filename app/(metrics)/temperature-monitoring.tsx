...
export default function TemperatureMonitoringScreen() {
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.infoContainer}>
        <View style={styles.infoRow}>
          <View style={styles.infoItem}>
            ...
            <Text style={styles.infoValue}>36.5 °C</Text>
          </View>
          <View style={styles.infoItem}>
      ...
      <View style={styles.analysisContainer}>
        ...
        <Text style={styles.analysisText}>
          No fever detected. Temperature is within normal range.
        </Text>
      </View>
      ...
      <View style={styles.historyContainer}>
        ...
        <View style={styles.eventItem}>
          ...
          <View style={styles.eventContent}>
            <Text style={styles.eventTitle}>Slight rise in temperature</Text>
            <Text style={styles.eventDescription}>Temperature rose to 37.1 °C during training.</Text>
          </View>
        </View>
        <View style={styles.eventItem}>
          <View style={styles.eventTimeContainer}>
          ...
          <View style={styles.eventContent}>
            ...
            <Text style={styles.eventDescription}>Temperature stable (36.5 °C).</Text>
          </View>
        </View>
      </View>
    </SafeAreaView>
...
const styles = StyleSheet.create({
  ...
  liveIndicator: { flexDirection: "row", alignItems: "center", backgroundColor: "rgba(255, 152, 0, 0.2)", paddingHorizontal: 12, paddingVertical: 6, borderRadius: 16 },
  liveDot: { width: 8, height: 8, borderRadius: 4, backgroundColor: "#FF9800", marginRight: 6 },
  liveText: { color: "#FF9800", fontSize: 14, fontWeight: "500" },
