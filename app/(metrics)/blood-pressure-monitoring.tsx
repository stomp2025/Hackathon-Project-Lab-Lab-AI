...
export default function BloodPressureMonitoringScreen() {
  // Données simulées de pression artérielle (systolique/diastolique)
  const systolic = Math.floor(Math.random() * 10 + 110)
  const diastolic = Math.floor(Math.random() * 5 + 70)
  const bpData = {
    labels: ["", "", "", "", "", ""],
    datasets: [
      {
        data: [
          ...
          Math.floor(Math.random() * 10 + 112),
          Math.floor(Math.random() * 10 + 115),
          Math.floor(Math.random() * 10 + 114),
          Math.floor(Math.random() * 10 + 113),
          Math.floor(Math.random() * 10 + 111),
        ],
        color: (opacity = 1) => `rgba(33, 150, 243, ${opacity})`,
      },
      {
        data: [
          Math.floor(Math.random() * 5 + 70),
          Math.floor(Math.random() * 5 + 72),
          Math.floor(Math.random() * 5 + 75),
          Math.floor(Math.random() * 5 + 74),
          Math.floor(Math.random() * 5 + 73),
          Math.floor(Math.random() * 5 + 71),
        ],
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.infoContainer}>
        <View style={styles.infoRow}>
          <View style={styles.infoItem}>
            ...
            <Text style={styles.infoValue}>{systolic}/{diastolic} mmHg</Text>
          </View>
          <View style={styles.infoItem}>
      ...
      <View style={styles.analysisContainer}>
        ...
        <Text style={styles.analysisText}>
          Blood pressure is within normal range. No hypertension detected.
        </Text>
      </View>
      ...
      <View style={styles.historyContainer}>
        ...
        <View style={styles.eventItem}>
          ...
          <View style={styles.eventContent}>
            <Text style={styles.eventTitle}>Slight elevation</Text>
            <Text style={styles.eventDescription}>BP rose to 130/85 mmHg after exercise.</Text>
          </View>
        </View>
        <View style={styles.eventItem}>
          <View style={styles.eventTimeContainer}>
          ...
          <View style={styles.eventContent}>
            ...
            <Text style={styles.eventDescription}>BP stable (115/75 mmHg).</Text>
          </View>
        </View>
      </View>
    </SafeAreaView>
